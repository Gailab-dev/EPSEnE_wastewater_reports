...
**유입수 모델 성능 지표 반영 완료**:
- 유입수 모델은 **StandardScaler를 적용**하여 개발
- 본 문서의 성능 지표를 스케일링 적용 후의 **실제 측정값**으로 업데이트
- **실제 성능**: Test R² = 0.9975, MAPE = 1.13% (목표 대비 크게 초과 달성)
- 상세 결과는 [01 유입수/req002_model.ipynb](01 유입수/req002_model.ipynb)를 참고
- 데이터 스케일링으로 **학습 안정성 및 예측 정확도가 대폭 향상** 되었음
...
**참고**: 위 성능 지표는 데이터 스케일링(StandardScaler) 적용 후 실제 측정값으로, 상세 결과는 [01 유입수/req002_model.ipynb](01 유입수/req002_model.ipynb)를 참고.
